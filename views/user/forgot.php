...
<html lang="en">
	...
	<body>
		<div class = "container login-form form-container" id = "user-form">
			<form action = "/user/forg" name = "password_forgot" class = "panel panel-shadow-uneven panel-content-lg" method = "POST" novalidate>
				<h4 class = "mb-3 action-header">Forgot your password?</h4>
				<p>Enter your email address. We'll send you instructions on how to reset your password.</p>
