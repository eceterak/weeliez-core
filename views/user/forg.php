...
<html lang="en">
	...
	<body>
		<div class = "container login-form form-container" id = "user-form">
			<div class = "panel panel-shadow-uneven panel-content">
				<h4 class = "mb-3 action-header">Forgot your password?</h4>
				<div>If a weeliez account exists for <?php echo $email; ?>, an email will be sent with further instructions.</div>
				<p class = "mt-2">Back to <a href = "/" class = "underline">weeliez.com</a></p>
			</div>
		</div>
		<!-- Footer END -->
		<!-- JQuery -->
