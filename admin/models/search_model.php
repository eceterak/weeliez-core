<?php
	...
	/**
	 * @file searchModel_model.php
	 * @author Marek Bartula <bartula.marek@gmail.com>
	 */

	class search extends \admin\model {
		...
		/**
		 * Get all attributes wuth attribute_search of value 1 and display them on advanced search form.
		 */
		 ...
		 * If $key is not an iteger, search will be executed on bike table - user is looking for bikes of make/category or between specific years of production.
		 * @queries:
