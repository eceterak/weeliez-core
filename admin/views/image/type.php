...
<?php else: ?>
	<?php foreach($images as $image): ?>
		<a href = "<?php echo ADMIN_URL.'/upload/images/'.$image->image_url; ?>">
			<img src = "<?php echo ADMIN_URL.'/upload/images/'.$image->image_url; ?>" style = "width: 200px; height: auto;" <?php echo ($image->image_default !== 0) ? 'class = "image_default"' : '' ; ?> />
		</a>
	<?php endforeach;?>
	<?php foreach($images as $image): ?>
		<table>
